...
````
Cette requêtte renverra un résultat avec l'auteur *Yves Lavandier* n'a aucun film associé dans la table movies et aura donc comme valeur NULL pour tous les champs se référant à la table ``movies``
